...
#Reading the files
df = read.csv("/rds/general/user/md2620/home/asthma/Malo/Dataframes/df_for_proto_after_stand_and_labeled.csv")
...
#Remove 0 variance OMICS
data_num_df  = subset(data_num_df , select = -c(Omics.Furoylglycine,Omics.Glutamic.acid,Omics.N.Acetylglutamic.acid,
...
num_cols <- unlist(lapply(df_2, is.numeric))
data_num <- df_2[ , num_cols] 
library(factoextra)

data_num  = subset(data_num , select = -c(Omics.Furoylglycine,Omics.Glutamic.acid,Omics.N.Acetylglutamic.acid,
                                                Omics.Phenylalanine,Omics.Allantoin,Omics.Isoleucine,Omics.N.Acetylputrescine,
                                                Omics.Sarcosine,Omics.Cytosine,Omics.Lysine,Omics.N.Methyl.D.aspartic.acid,
                                                Omics.Xanthosine,Omics.Glucosamine,Omics.Maltose,Omics.O.Acetylserine,
                                                Omics.Xylose))
...
hop_random <- res_random$plot

phop1 <- hop_df+
  labs(title="Ordered Dissimilarity Image (ODI)", 
       subtitle="Clustering tendency of the dataset - include numerical variables only",
       caption="Red = High Similarity ; Blue = High Dissimilarity")
phop1

phop2 <- hop_random + 
  labs(title="Ordered Dissimilarity Image (ODI)", 
       subtitle="Clustering tendency of a randomly generated dataset",
       caption="Red = High Similarity ; Blue = High Dissimilarity")
phop2
library(patchwork)
phop1 + phop2
ggsave("/rds/general/user/md2620/home/asthma/Malo/Results/Hopkins/Hopkins_stats.jpeg", width = 18, height = 8)
##Good to go
...
df_2_prot <- df_2[-1]
row.names(df_2_prot) <- df_2$X
View(df_2_prot)

###Remove all OMICs data before clustering
df_2_prot_updated <- df_2_prot %>%
  dplyr::select(-starts_with("Omics."))

##Select only numerical variables from df_2_prot_updated
num_cols_updated <- unlist(lapply(df_2_prot_updated, is.numeric))
data_num_updated <- df_2_prot_updated[ , num_cols_updated] 

##Run Hopkins stats on df_prot_2_updated
# Compute Hopkins statistic for df_2_prot_updated dataset
res_without_OMICs <- factoextra::get_clust_tendency(data_num_updated, n = nrow(data_num_updated)-1, graph = TRUE)
res_without_OMICs$hopkins_stat
res_without_OMICs$plot

# apply k prototypes - use 2 to 10 clusters
kpres_2 <- kproto(df_2_prot, 2, keep.data=TRUE)
kpres_3 <- kproto(df_2_prot, 3, keep.data=TRUE)
kpres <- kproto(df_2_prot, 4, keep.data=TRUE)
kpres_5 <- kproto(df_2_prot, 5, keep.data=TRUE)
kpres_6 <- kproto(df_2_prot, 6, keep.data=TRUE)
kpres_7 <- kproto(df_2_prot, 7, keep.data=TRUE)
kpres_8 <- kproto(df_2_prot, 8, keep.data=TRUE)
kpres_9 <- kproto(df_2_prot, 9, keep.data=TRUE)
kpres_10 <- kproto(df_2_prot, 10, keep.data=TRUE)

#If you want to see where differences come from among the different clusters (viz)
#clprofiles(kpres_2,df_2_prot)
#clprofiles(kpres_3,df_2_prot)
#clprofiles(kpres,df_2_prot)
#clprofiles(kpres_5,df_2_prot)
#clprofiles(kpres_6,df_2_prot)
#clprofiles(kpres_7,df_2_prot)
#clprofiles(kpres_8,df_2_prot)
#clprofiles(kpres_9,df_2_prot)
#clprofiles(kpres_10,df_2_prot)
...
#### NOTE APPART #####
kpres$cluster #each datapoint appended to its respective cluster.
######################

#Transform to matrix the dataframe, also it can be handled by intCriteria function
df_2_prot_matrix = data.matrix(df_2_prot)

results_kpres_2 = intCriteria(df_2_prot_matrix,kpres_2$cluster,"all")
df_results_kpres_2 = as.data.frame(results_kpres_2,row.names = "2")
df_results_kpres_2$K <- row.names(df_results_kpres_2)

results_kpres_3 = intCriteria(df_2_prot_matrix,kpres_3$cluster,"all")
df_results_kpres_3 = as.data.frame(results_kpres_3,row.names = "3")
df_results_kpres_3$K <- row.names(df_results_kpres_3)

#Append together df_results_kpres_2 and df_results_kpres_3
df_results_kpres_2_3 = dplyr::bind_rows(df_results_kpres_2,df_results_kpres_3)

results_kpres = intCriteria(df_2_prot_matrix,kpres$cluster,"all")
df_results_kpres = as.data.frame(results_kpres,row.names = "4")
df_results_kpres$K <- row.names(df_results_kpres)

#Append together df_results_kpres_2_3 and df_results_kpres
df_results_kpres_2_3_4 = dplyr::bind_rows(df_results_kpres_2_3,df_results_kpres)

results_kpres_5 = intCriteria(df_2_prot_matrix,kpres_5$cluster,"all")
df_results_kpres_5 = as.data.frame(results_kpres_5,row.names = "5")
df_results_kpres_5$K <- row.names(df_results_kpres_5)

#Append together df_results_kpres_2_3_4 and df_results_kpres_5
df_results_kpres_2_to_5 = dplyr::bind_rows(df_results_kpres_2_3_4,df_results_kpres_5)

results_kpres_6 = intCriteria(df_2_prot_matrix,kpres_6$cluster,"all")
df_results_kpres_6 = as.data.frame(results_kpres_6,row.names = "6")
df_results_kpres_6$K <- row.names(df_results_kpres_6)

#Append together df_results_kpres_2_to_5 and df_results_kpres_6
df_results_kpres_2_to_6 = dplyr::bind_rows(df_results_kpres_2_to_5,df_results_kpres_6)

results_kpres_7 = intCriteria(df_2_prot_matrix,kpres_7$cluster,"all")
df_results_kpres_7 = as.data.frame(results_kpres_7,row.names = "7")
df_results_kpres_7$K <- row.names(df_results_kpres_7)

#Append together df_results_kpres_2_to_6 and df_results_kpres_7
df_results_kpres_2_to_7 = dplyr::bind_rows(df_results_kpres_2_to_6,df_results_kpres_7)

results_kpres_8 = intCriteria(df_2_prot_matrix,kpres_8$cluster,"all")
df_results_kpres_8 = as.data.frame(results_kpres_8,row.names = "8")
df_results_kpres_8$K <- row.names(df_results_kpres_8)

#Append together df_results_kpres_2_to_7 and df_results_kpres_8
df_results_kpres_2_to_8 = dplyr::bind_rows(df_results_kpres_2_to_7,df_results_kpres_8)

results_kpres_9 = intCriteria(df_2_prot_matrix,kpres_9$cluster,"all")
df_results_kpres_9 = as.data.frame(results_kpres_9,row.names = "9")
df_results_kpres_9$K <- row.names(df_results_kpres_9)

#Append together df_results_kpres_2_to_8 and df_results_kpres_9
df_results_kpres_2_to_9 = dplyr::bind_rows(df_results_kpres_2_to_8,df_results_kpres_9)

results_kpres_10 = intCriteria(df_2_prot_matrix,kpres_10$cluster,"all")
df_results_kpres_10 = as.data.frame(results_kpres_10,row.names = "10")
df_results_kpres_10$K <- row.names(df_results_kpres_10)

#Append together df_results_kpres_2_to_9 and df_results_kpres_10
df_results_kpres_2_to_10 = dplyr::bind_rows(df_results_kpres_2_to_9,df_results_kpres_10)
...
#################### Plot C_Index #####################
pdf(file = "/rds/general/user/md2620/home/asthma/Malo/Results/Optimal_K/Cindex.pdf",   # The directory you want to save the file in
    width = 8, # The width of the plot in inches
    height = 8)
plot(df_results_kpres_2_to_10$K,df_results_kpres_2_to_10$c_index, frame = TRUE, 
     col = "black",
     type = "o",
     pch = 21,
     bg = ifelse(df_results_kpres_2_to_10$c_index == min(df_results_kpres_2_to_10$c_index), "red", "black"),
...
pdf(file = "/rds/general/user/md2620/home/asthma/Malo/Results/Optimal_K/Calinski_Harabasz.pdf",   # The directory you want to save the file in
    width = 8, # The width of the plot in inches
    height = 8)
plot(df_results_kpres_2_to_10$K,df_results_kpres_2_to_10$calinski_harabasz, frame = TRUE, 
     col = "black",
     type = "o",
     pch = 21,
     bg = ifelse(df_results_kpres_2_to_10$calinski_harabasz == max(df_results_kpres_2_to_10$calinski_harabasz), "red", "black"),
     xlab="Number of clusters K",
...
#################### Plot Dunn score #####################
pdf(file = "/rds/general/user/md2620/home/asthma/Malo/Results/Optimal_K/Dunn.pdf",   # The directory you want to save the file in
    width = 8, # The width of the plot in inches
    height = 8)

plot(df_results_kpres_2_to_10$K,df_results_kpres_2_to_10$dunn, frame = TRUE, 
     col = "black",
     type = "o",
     pch = 21,
     bg = ifelse(df_results_kpres_2_to_10$dunn == max(df_results_kpres_2_to_10$dunn), "red", "black"),
     xlab="Number of clusters K",
     ylab="Dunn score")
...
#################### Plot Gamma score #####################
pdf(file = "/rds/general/user/md2620/home/asthma/Malo/Results/Optimal_K/gamma.pdf",   # The directory you want to save the file in
    width = 8, # The width of the plot in inches
    height = 8)

plot(df_results_kpres_2_to_10$K,df_results_kpres_2_to_10$gamma, frame = TRUE, 
     col = "black",
     type = "o",
     pch = 21,
     bg = ifelse(df_results_kpres_2_to_10$gamma == max(df_results_kpres_2_to_10$gamma), "red", "black"),
     xlab="Number of clusters K",
     ylab="Gamma score")
legend("topright", legend = "optimum criterion : max")
...
#################### Plot Gplus score #####################
pdf(file = "/rds/general/user/md2620/home/asthma/Malo/Results/Optimal_K/gplus.pdf",   # The directory you want to save the file in
    width = 8, # The width of the plot in inches
    height = 8)

plot(df_results_kpres_2_to_10$K,df_results_kpres_2_to_10$g_plus, frame = TRUE, 
     col = "black",
     type = "o",
     pch = 21,
     bg = ifelse(df_results_kpres_2_to_10$g_plus == max(df_results_kpres_2_to_10$g_plus), "red", "black"),
     xlab="Number of clusters K",
     ylab="Gplus score")
legend("topright", legend = "optimum criterion : max")
...
#################### Plot mcclain score #####################
pdf(file = "/rds/general/user/md2620/home/asthma/Malo/Results/Optimal_K/mcclain.pdf",   # The directory you want to save the file in
    width = 8, # The width of the plot in inches
    height = 8)

plot(df_results_kpres_2_to_10$K,df_results_kpres_2_to_10$mcclain_rao, frame = TRUE, 
     col = "black",
     type = "o",
     pch = 21,
     bg = ifelse(df_results_kpres_2_to_10$mcclain_rao == min(df_results_kpres_2_to_10$mcclain_rao), "red", "black"),
     xlab="Number of clusters K",
     ylab="Mcclain score")
legend("topright", legend = "optimum criterion : min")
...
pdf(file = "/rds/general/user/md2620/home/asthma/Malo/Results/Optimal_K/ptbiserial.pdf",   # The directory you want to save the file in
    width = 8, # The width of the plot in inches
    height = 8)

plot(df_results_kpres_2_to_10$K,df_results_kpres_2_to_10$point_biserial, frame = TRUE, 
     col = "black",
     type = "o",
     pch = 21,
     bg = ifelse(df_results_kpres_2_to_10$point_biserial == max(df_results_kpres_2_to_10$point_biserial), "red", "black"),
     xlab="Number of clusters K",
...
#################### Plot tau score #####################
pdf(file = "/rds/general/user/md2620/home/asthma/Malo/Results/Optimal_K/tau.pdf",   # The directory you want to save the file in
    width = 8, # The width of the plot in inches
    height = 8)

plot(df_results_kpres_2_to_10$K,df_results_kpres_2_to_10$tau, frame = TRUE, 
     col = "black",
     type = "o",
     pch = 21,
     bg = ifelse(df_results_kpres_2_to_10$tau == max(df_results_kpres_2_to_10$tau), "red", "black"),
     xlab="Number of clusters K",
     ylab="Tau score")
legend("topright", legend = "optimum criterion : max")
...
############################ Simulation study with different indexes to find optimal number of clusters ########################

############ calculate optimal number of cluster, index values and cluster partition with Silhouette-index ############
k_max <- 10 
val_sil <- validation_kproto(method = "silhouette", data = df_2_prot, k = 2:k_max, nstart = 5)

#Save results for silhouette score
setwd("/rds/general/user/md2620/home/asthma/Malo/Results/Optimal_K")
#install.packages("rlist")
require(rlist)
list.save(val_sil, 'silhouette.rds')

#Plot results from silhouette index
pdf(file = "/rds/general/user/md2620/home/asthma/Malo/Results/Optimal_K/Silhouette.pdf",   # The directory you want to save the file in
    width = 8, # The width of the plot in inches
    height = 8)
...
dev.off()
#According to silhouette score, optimal number of clusters k=3


############# calculate optimal number of cluster, index values and cluster partition with dunn #############
n_iter <- 50
...
for(i in 1:n_iter) {
  val_dunn <- validation_kproto(method = "dunn", data = df_2_prot, k = 2:k_max, nstart = 5)
  
  #Save results for dunn score
  setwd("/rds/general/user/md2620/home/asthma/Malo/Results/Optimal_K")
  #install.packages("rlist")
  require(rlist)
  list.save(val_dunn, 'dunn.rds')
  
  #Plot results from dunn index
  pdf(file = "/rds/general/user/md2620/home/asthma/Malo/Results/Optimal_K/dunn.pdf",   # The directory you want to save the file in
      width = 8, # The width of the plot in inches
      height = 8)
  
  plot(2:k_max,val_dunn$indices, frame = TRUE, 
       col = "black",
       type = "o",
       pch = 21,
       bg = ifelse(val_dunn$indices == max(val_dunn$indices), "red", "black"),
       xlab="Number of clusters K",
       ylab="Dunn Score")
  legend("topright", legend = "optimum criterion : max")
  title(main = "Dunn Score for K-prototypes")
...
for(i in 1:n_iter){
  ...
  val_gamma <- validation_kproto(method = "gamma", data = df_2_prot, k = 2:k_max, nstart = 5)
  
  #Save results for gamma index
  setwd("/rds/general/user/md2620/home/asthma/Malo/Results/Optimal_K")
  #install.packages("rlist")
  require(rlist)
  list.save(val_gamma, 'gamma.rds')
  
  #Plot results from gamma index
  pdf(file = "/rds/general/user/md2620/home/asthma/Malo/Results/Optimal_K/gamma.pdf",   # The directory you want to save the file in
      width = 8, # The width of the plot in inches
      height = 8)
  
  plot(2:k_max,val_gamma$indices, frame = TRUE, 
       col = "black",
       type = "o",
       pch = 21,
       bg = ifelse(val_gamma$indices == max(val_gamma$indices), "red", "black"),
       xlab="Number of clusters K",
       ylab="Gamma index")
  legend("topright", legend = "optimum criterion : max")
  title(main = "Gamma Index for K-prototypes")
...
close(pb)
############# calculate optimal number of cluster, index values and cluster partition with gamma #############
val_gamma <- validation_kproto(method = "gamma", data = df_2_prot, k = 2:4, nstart = 5)
...
############# calculate optimal number of cluster, index values and cluster partition with gplus #############
val_gplus <- validation_kproto(method = "gplus", data = df_2_prot, k = 2:k_max, nstart = 5)

#Save results for gplus index
setwd("/rds/general/user/md2620/home/asthma/Malo/Results/Optimal_K")
#install.packages("rlist")
require(rlist)
list.save(val_gplus, 'gplus.rds')

#Plot results from gplus index
pdf(file = "/rds/general/user/md2620/home/asthma/Malo/Results/Optimal_K/gplus.pdf",   # The directory you want to save the file in
    width = 8, # The width of the plot in inches
    height = 8)

plot(2:k_max,val_gplus$indices, frame = TRUE, 
     col = "black",
     type = "o",
     pch = 21,
     bg = ifelse(val_gplus$indices == max(val_gplus$indices), "red", "black"),
     xlab="Number of clusters K",
     ylab="Gplus index")
legend("topright", legend = "optimum criterion : max")
title(main = "Gplus Index for K-prototypes")

dev.off()


############# calculate optimal number of cluster, index values and cluster partition with mcclain #############
val_mcclain <- validation_kproto(method = "mcclain", data = df_2_prot, k = 2:k_max, nstart = 5)

#Save results for mcclain index
setwd("/rds/general/user/md2620/home/asthma/Malo/Results/Optimal_K")
#install.packages("rlist")
require(rlist)
list.save(val_mcclain, 'mcclain.rds')

#Plot results from mcclain index
pdf(file = "/rds/general/user/md2620/home/asthma/Malo/Results/Optimal_K/mcclain.pdf",   # The directory you want to save the file in
    width = 8, # The width of the plot in inches
    height = 8)

plot(2:k_max,val_mcclain$indices, frame = TRUE, 
     col = "black",
     type = "o",
     pch = 21,
     bg = ifelse(val_mcclain$indices == min(val_mcclain$indices), "red", "black"),
     xlab="Number of clusters K",
     ylab="Mcclain index")
legend("topright", legend = "optimum criterion : min")
title(main = "Mcclain Index for K-prototypes")

dev.off()



############# calculate optimal number of cluster, index values and cluster partition with ptbiserial #############
val_ptbiserial <- validation_kproto(method = "ptbiserial", data = df_2_prot, k = 2:k_max, nstart = 5)

#Save results for ptbiserial index
setwd("/rds/general/user/md2620/home/asthma/Malo/Results/Optimal_K")
#install.packages("rlist")
require(rlist)
list.save(val_ptbiserial, 'ptbiserial.rds')

#Plot results from ptbiserial index
pdf(file = "/rds/general/user/md2620/home/asthma/Malo/Results/Optimal_K/ptbiserial.pdf",   # The directory you want to save the file in
    width = 8, # The width of the plot in inches
    height = 8)

plot(2:k_max,val_ptbiserial$indices, frame = TRUE, 
     col = "black",
     type = "o",
     pch = 21,
     bg = ifelse(val_ptbiserial$indices == max(val_ptbiserial$indices), "red", "black"),
     xlab="Number of clusters K",
     ylab="Ptbiserial index")
legend("topright", legend = "optimum criterion : max")
title(main = "Ptbiserial Index for K-prototypes")

dev.off()



############# calculate optimal number of cluster, index values and cluster partition with tau #############
val_tau <- validation_kproto(method = "tau", data = df_2_prot, k = 2:k_max, nstart = 5)

#Save results for tau index
setwd("/rds/general/user/md2620/home/asthma/Malo/Results/Optimal_K")
#install.packages("rlist")
require(rlist)
list.save(val_tau, 'tau.rds')

#Plot results from tau index
pdf(file = "/rds/general/user/md2620/home/asthma/Malo/Results/Optimal_K/tau.pdf",   # The directory you want to save the file in
    width = 8, # The width of the plot in inches
    height = 8)

plot(2:k_max,val_tau$indices, frame = TRUE, 
     col = "black",
     type = "o",
     pch = 21,
     bg = ifelse(val_tau$indices == max(val_tau$indices), "red", "black"),
     xlab="Number of clusters K",
     ylab="Tau index")
legend("topright", legend = "optimum criterion : max")
title(main = "Tau Index for K-prototypes")
